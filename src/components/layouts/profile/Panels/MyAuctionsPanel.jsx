...
import { searchLoading, searchMyAuctions } from "../../../../redux/state/search";
...
import MyAuctionsList from "../Lists/MyAuctionsList";
...
const MyAuctionsPanel = ({ title }) => {
  ...
  const fetchInfo = async (searchAndSortParams) => {
    await dispatch(searchMyAuctions(searchAndSortParams))
      .then(() => {
